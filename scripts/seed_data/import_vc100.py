"""One-off import: vc100_seed_connections.csv -> the shared graph.
...
CSV_PATH = str(Path(__file__).resolve().parent / "vc100_seed_connections.csv")

# Same vocabulary as tech100/finance100's TYPE_MAP -- vc100's relationship_type
# column (cofounder, colleague, spouse, friend, family, investor, executive,
# portfolio_founder) is a strict subset, no new mappings needed.
TYPE_MAP = {
    "colleague": "coworker",
