"""One-off import: athletes_seed_connections.csv -> the shared graph.
...
CSV_PATH = str(Path(__file__).resolve().parent / "athletes_seed_connections.csv")

# Mostly the tech100/finance100/vc100 vocabulary, with three sports-specific
# readings:
#
#   agent/manager -> advisor. A sports agent or athlete manager is a retained
#     professional representative, which is what "advisor" means here; there is
#     no dedicated RELATIONSHIP_TYPES entry for representation.
#   partner -> family_social, NOT coworker. In vc100 "partner" meant a business
#     partner at a firm; in this file every one of the 11 rows is a romantic
#     partner (Sue Bird/Megan Rapinoe, Verstappen/Kelly Piquet, ...). Mapping it
#     to coworker would assert a professional tie that the evidence note flatly
#     contradicts -- and would skip derive_status's family_social cap, promoting
#     a personal-life claim to a strong professional edge.
TYPE_MAP = {
    "colleague": "coworker",
    ...
    "partner": "family_social",
    "ex-partner": "family_social",
