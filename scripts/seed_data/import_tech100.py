"""One-off import: tech100_seed_connections.csv -> the shared graph.
...
CSV_PATH = str(Path(__file__).resolve().parent / "tech100_seed_connections.csv")

# CSV vocabulary -> app.models.RELATIONSHIP_TYPES. Personal ties collapse to
# family_social (derive_status caps it at "candidate" regardless of
# confidence -- the app's own designed-in skepticism toward personal-life
# claims vs. professional-record ones, and this import doesn't need to
# fight that, just feed it honestly).
TYPE_MAP = {
    "colleague": "coworker",
